...
from .views import MyPostsAPI, PostsAPI, PostImageAPI, SearchView, PostDetailAPI, my_posts, post_create, post_edit, \
    post_detail, post_delete, CommentsAPI, create_comment, PostLikesAPI
...
urlpatterns = [
    ...
    path('api/authors/<str:author_id>/posts/<str:post_id>/likes', PostLikesAPI.as_view(), name="post_like_api"),
]
